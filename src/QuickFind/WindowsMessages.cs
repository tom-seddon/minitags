...
namespace QuickFind
{
    public static class WindowsMessages
    {
        ...
        public static void ForwardKeyMessageWithNewKey(Control target, Message m, Keys key)
        {
            if (target != null)
            {
                // this doesn't change the scan code part of LParam.
                // fortunately the list view doesn't seem to check.
                m.WParam = (IntPtr)key;

                SendMessage(new HandleRef(target, target.Handle), (uint)m.Msg, m.WParam, m.LParam);
